...
--13. Copy top 3 students based on SPI into TOPPER_LIST. 
	...
	DROP TABLE TOPPER_LIST
	SELECT* FROM TOPPER_LIST

--14. Copy distinct CITY from STUDENT into CITY_LIST. [dbo].[DEPOSIT]
